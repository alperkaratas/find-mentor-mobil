        ...
        <View style={{paddingLeft: 10}}>
          ...
          <View>
            <Text style={{marginBottom: 3}}>
              This platform getting 1m+ page views per month. Add yourself as a
              job seeker, totally free to add! The job seekers are{' '}
              <Text style={{fontWeight: 'bold'}}>sorted by contributions</Text>.
              ...
              <TouchableOpacity
                ...
                <Text style={{color: '#007bff', position: 'relative', top: 3}}>
                  mentorship
                </Text>
              </TouchableOpacity>{' '}
              projects, that's the way you can be shown your profile.
            </Text>
          </View>
        </View>
        <View>
